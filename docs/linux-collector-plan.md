...
The current collector uses `PERF_COUNT_HW_CACHE_MISSES`, exposed as `cache_misses_per_event`—not L3 attribution. Use PMU-specific event discovery before adding a CPU-specific L3 claim.
